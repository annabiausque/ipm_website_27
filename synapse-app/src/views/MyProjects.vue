  ...
  <div>
    ...
    <div class="mt-4">
      ...
      <div v-if="notification" class="notification-banner bg-green-500 text-white p-4 rounded mb-4">
        ...
        <div :style="user.isTeacher ? { minWidth: '475px' } : {}" class="my-6 overflow-hidden bg-white rounded-md shadow">
          <table class="w-full text-left border-collapse">
            <thead class="border-b">
              <tr>
                ...
                <th v-if="user.isTeacher" class="px-7 py-3 text-sm font-medium text-gray-100 uppercase bg-indigo-800 border-l">
                  Code
                </th>
                <th :class="!user.isTeacher ? 'border-l' : ''" class="px-4 py-3 text-sm font-medium text-gray-100 uppercase bg-indigo-800 text-right">
                  Next deadline
                </th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(project, id) in projects" :key="id" class="hover:bg-gray-300 border-b border-gray-400"
                ...
                <td style="width: 120px" v-if="user.isTeacher" class="px-7 py-4 text-lg text-gray-700 border-l border-gray-600">
                  {{ project.short_code }}
                </td>
                <td style="width: 120px;" :class="!user.isTeacher ? 'border-l border-gray-600' : ''" class="px-4 py-4 text-gray-500 text-right">
                  {{ project.end_date }}
                </td>
              </tr>
            </tbody>
